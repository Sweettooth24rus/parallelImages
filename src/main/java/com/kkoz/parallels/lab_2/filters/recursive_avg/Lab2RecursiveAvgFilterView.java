...
@Route("/labs/2/filters/recursive_avg")
public class Lab2RecursiveAvgFilterView extends View<Lab2RecursiveAvgFilterPresenter> {
    ...
    public Lab2RecursiveAvgFilterView() {
        super(Lab2RecursiveAvgFilterPresenter.class, Labs.LAB_2);
